...
public class L_GridImageAdapter extends
        RecyclerView.Adapter<L_GridImageAdapter.ViewHolder> {
    ...
    public L_GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
      ...
      //      viewHolder.mImg.setImageResource(R.drawable.addimg);
            String url = "res://com.zhhl.kuangjia/" + R.drawable.addimg;
